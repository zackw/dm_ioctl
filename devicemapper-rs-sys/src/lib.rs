...
pub const DM_VERSION_CMD: c_uint = 0;

///  Remove all dm devices, destroy all tables.  Only really used for debug.
pub const DM_REMOVE_ALL_CMD: c_uint = 1;

/// Get a list of all the dm device names.
pub const DM_LIST_DEVICES_CMD: c_uint = 2;

/// Create a new device, neither the 'active' or 'inactive' table
/// slots will be filled.  The device will be in suspended state
/// after creation, however any io to the device will get errored
/// since it will be out-of-bounds.
pub const DM_DEV_CREATE_CMD: c_uint = 3;

/// Remove a device, destroy any tables.
pub const DM_DEV_REMOVE_CMD: c_uint = 4;

/// Rename a device or set its uuid if none was previously supplied.
pub const DM_DEV_RENAME_CMD: c_uint = 5;
...
/// is resumed.
pub const DM_DEV_SUSPEND_CMD: c_uint = 6;

/// Retrieves the status for the table in the 'active' slot.
pub const DM_DEV_STATUS_CMD: c_uint = 7;

/// Wait for a significant event to occur to the device.  This
/// could either be caused by an event triggered by one of the
/// targets of the table in the 'active' slot, or a table change.
pub const DM_DEV_WAIT_CMD: c_uint = 8;

/// Load a table into the 'inactive' slot for the device.  The
/// device does _not_ need to be suspended prior to this command.
pub const DM_TABLE_LOAD_CMD: c_uint = 9;

/// Destroy any table in the 'inactive' slot (ie. abort).
pub const DM_TABLE_CLEAR_CMD: c_uint = 10;

/// Return a set of device dependencies for the 'active' table.
pub const DM_TABLE_DEPS_CMD: c_uint = 11;

/// Return the targets status for the 'active' table.
pub const DM_TABLE_STATUS_CMD: c_uint = 12;

/// ???
pub const DM_LIST_VERSIONS_CMD: c_uint = 13;

/// Pass a message string to the target at a specific offset of a device.
pub const DM_TARGET_MSG_CMD: c_uint = 14;
...
pub const DM_DEV_SET_GEOMETRY_CMD: c_uint = 15;

/// ???
pub const DM_DEV_ARM_POLL_CMD: c_uint = 16;
